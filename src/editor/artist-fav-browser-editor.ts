...
const CONFIG_SETTINGS_SCHEMA = [
  ...
  {
    name: 'artistFavBrowserItemsLimit',
  ...
  {
    name: 'artistFavBrowserItemsPerRow',
  ...
  {
    name: 'artistFavBrowserFilterDisabled',
    label: 'Disable filter input',
    required: false,
    selector: { boolean: {} },
  },
  {
    name: 'artistFavBrowserItemsHideTitle',
    label: 'Hide item row title text',
    required: false,
    selector: { boolean: {} },
  },
  {
    name: 'artistFavBrowserItemsHideSubTitle',
  ...
  {
    name: 'artistFavBrowserItemsSortTitle',
    label: 'Sort items by Title',
    required: false,
    selector: { boolean: {} },
  },
  {
    name: 'artistFavBrowserShuffleOnPlay',
...
class ArtistFavBrowserEditor extends BaseEditor {
...
customElements.define('spc-artist-fav-browser-editor', ArtistFavBrowserEditor);
