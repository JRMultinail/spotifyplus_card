  ...
  */
  ...
  protected override updateMediaList(player: MediaPlayer): boolean {
    ...
    try {
      ...
      const promiseUpdateMediaList = new Promise((resolve, reject) => {
        ...
        this.spotifyPlusService.GetShowFavorites(player, 0, 0, limitTotal, sortResult, excludeAudiobooks)
          ...
          .catch(error => {
            ...
            super.updatedMediaListError("Get Show Favorites failed: " + getHomeAssistantErrorMessage(error));
      ...
      super.updatedMediaListError("Show favorites refresh failed: " + getHomeAssistantErrorMessage(error));
      return true;
